"""Pruebas unitarias del patron Singleton (ConfiguracionGlobal).

Ejecucion: python -m unittest test_configuracion_global.py -v
"""
...
class TestSingletonConfiguracionGlobal(unittest.TestCase):
    ...
    def test_02_valores_iniciales_por_defecto(self):
        ...
        self.assertEqual(config.obtener_url_base_datos(), "postgresql://localhost:5432/streaming_db")
    ...
    def test_03_estado_compartido_entre_referencias(self):
        ...
        instancia_b = ConfiguracionGlobal.obtener_instancia()
        self.assertEqual(instancia_b.obtener_url_base_datos(), "postgresql://prod:5432/streaming_db")
